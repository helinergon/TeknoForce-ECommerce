...
namespace TeknoForce.Migrations
{
    ...
    [Migration("20260305084328_AddAddressFieldsToOrder")]
    partial class AddAddressFieldsToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeknoForce.Data.Models.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            FailedLoginCount = 0,
                            Password = "AQAAAAIAAYagAAAAEC7ShM1n0ak39mp20Rm7vCfdDJOeyRWHjg1C4GsMjRkJMf8PAW6vuQabt4e6XBKlMQ==",
                            Username = "teknoforce"
                        });
                });
